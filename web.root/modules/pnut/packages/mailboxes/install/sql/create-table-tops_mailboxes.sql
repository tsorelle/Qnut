...
INSERT INTO tops_mailboxes (id, mailboxcode,  address,  displayText,  description,  createdby,  createdon,  changedby,  changedon,  active,  public)
VALUES (2,'bounce','bounce@yoursite.org','Bounce address','Bounce mailbox (please update)','system',CURRENT_DATE,'system',CURRENT_DATE,1,1);

INSERT INTO tops_mailboxes (id, mailboxcode,  address,  displayText,  description,  createdby,  createdon,  changedby,  changedon,  active,  public)
VALUES (3,'admin','admin@yoursite.org','Site Administrator','Administrator mailbox (please update)','system',CURRENT_DATE,'system',CURRENT_DATE,1,1);
